...
/* @var $searchModel app\modules\gisposts\models\media\SearchFileType */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : Yii::t('app', 'File Types');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới File Types','class'=>'btn btn-success']).
            ...
            'panel' => [
                ...
                'heading' => '<i class="glyphicon glyphicon-list"></i> File Types listing',
                'before'=>'',
