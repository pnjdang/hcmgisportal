...
$this->params['breadcrumbs'][] = 'Danh sách hợp đồng không có';
?>
<div class="row">
    <div class="col-lg-12">
...
//                ],
            ...
            'toolbar' => [
                'content' =>
                    "<a target='_blank' title='Xuất danh sách hợp đồng không có' data-pjax='0' href='" . Yii::$app->urlManager->createUrl('quan-ly/hopdong/export?q=khongco&' . $paramString) . "' class='btn btn-default'><span class='fa fa-file-excel-o'></span> Xuất file</a>"
            ],
            'striped' => false,
            'condensed' => true,
            'responsive' => true,
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách hợp đồng không có',
                'after' => false,
            ]
        ]) ?>
    </div>
