...
$this->params['breadcrumbs'][] = 'Danh sách hợp đồng sắp hết hạn';
?>
<div class="row">
    <div class="col-lg-12">
...
<div class="row">
    <div class="col-lg-12">
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        ...
                        $updateButton = "<a href='" . Yii::$app->urlManager->createUrl(['quan-ly/hopdong/update', 'id' => $model->id_hopdong]). "' class='btn btn-warning btn-xs'><i class='fa fa-pencil'></i></a>";
                        $deleteButton = "<a href='" . Yii::$app->urlManager->createUrl(['quan-ly/hopdong/delete', 'id' => $model->id_hopdong]). "' class='btn btn-danger btn-xs' role='modal-remote'><i class='fa fa-trash'></i></a>";
            ...
            'toolbar' => [
                ['content' =>
                    "<a target='_blank' title='Xuất danh sách hợp đồng sắp hết hạn' data-pjax='0' href='" . Yii::$app->urlManager->createUrl('quan-ly/hopdong/export?q=saphethan&' . $paramString) . "' class='btn btn-default'><span class='fa fa-file-excel-o'></span> Xuất file</a>"
                ],
            ],
            'striped' => false,
            'condensed' => true,
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách hợp đồng sắp hết hạn',
                'after' => false,
            ]
        ]) ?>
    </div>
