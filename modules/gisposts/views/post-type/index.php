...
/* @var $searchModel app\modules\gisposts\models\categories\SearchPostType */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : Yii::t('app', 'Post Types');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Post Types','class'=>'btn btn-success']).
            ...
            'panel' => [
                ...
                'heading' => '<i class="glyphicon glyphicon-list"></i> Post Types listing',
                'before'=>'',
