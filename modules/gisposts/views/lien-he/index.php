...
/* @var $searchModel app\modules\gisposts\models\SearchLienHe */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : Yii::t('app', 'Lien Hes');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Lien Hes','class'=>'btn btn-success']).
            ...
            'panel' => [
                ...
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lien Hes listing',
                'before'=>'',
