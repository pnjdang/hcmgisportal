 ...
 */
class SearchChuyengiaLinhvuc extends Chuyengia
{
    public $ten_donvi;
    public $ten_hh;
    public $ten_hv;
    ...
    {
        $query = Chuyengia::find()->joinWith(['chuyengiaLinhvucs','donvi','hocham','hocvi'])->where(['cap1_id' => $id])->andWhere(['chuyengia.status' => 1]);
