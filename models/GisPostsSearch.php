...
/**
 * GisPostsSearch represents the model behind the search form about `app\models\GisPosts`.
 */
class GisPostsSearch extends GisPosts
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['post_date', 'post_date_gmt', 'post_content', 'post_title', 'post_img', 'post_status', 'comment_status', 'ping_status', 'post_password', 'post_name', 'to_ping', 'pinged', 'post_modified', 'post_modified_gmt', 'post_content_filtered', 'guid', 'post_type', 'post_mime_type'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'upper(post_content)', mb_strtoupper($this->post_content)])
            ...
            ->andFilterWhere(['like', 'upper(post_type)', mb_strtoupper($this->post_type)])
