...
<div class="modal-header">
    ...
    <h4 class="modal-title">Xóa phiếu đăng ký thông tin phòng thí nghiệm</h4>
</div>
<?php $form = ActiveForm::begin(); ?>
<div class="modal-body">
    <div class="col-sm-12">
        <h4>Bạn chắc chắn muốn xóa Phiếu đăng ký thông tin Phòng thí nghiệm: <?= $model['phongthinghiem']->ten_tv?>?</h4>
    </div>
