        ...
        <div class="col-md-12 col-sm-12">
            <div class="portlet box green" id="notice">
                <div class="portlet-title">
                    <div class="caption"><span class="fa fa-check-circle-o"></span> Cập nhật phiếu đăng ký phòng thí nghiệm thành công!
                    </div>
                </div>
            </div>
        </div>
...
<?php if (isset($created)): ?>
    <div class="row">
        <div class="col-md-12 col-sm-12">
            <div class="portlet box green" id="notice">
                <div class="portlet-title">
                    <div class="caption"><span class="fa fa-check-circle-o"></span> Tạo mới phiếu đăng ký phòng thí nghiệm thành công!
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="portlet-body">
                <div id="ajaxCrudDatatable">
                    ...
                    GridView::widget([
                        ...
                        'toolbar' => [
                            ['content' =>
                                Html::a('Đăng ký mới', Yii::$app->urlManager->createUrl('user/phongthinghiem/create'), ['title' => 'Đăng ký thông tin phòng thí nghiệm', 'class' => 'btn btn-success']) .
