    ...
    <div class="col-lg-12">
        <div class="portlet light" id="form_wizard_1">
            <div class="portlet-title">
                <div class="caption">
                    <span class="font-blue-steel">Cập nhật thông tin đăng ký phòng thí nghiệm</span>
                </div>
            </div>
                        ...
                        <div class="form-actions" style="text-align: center">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button type="button"  class="btn green button-submit" onclick="submit('<?=Yii::$app->urlManager->createUrl('/user/pdkphongthinghiem/update')?>')"> Cập nhật
