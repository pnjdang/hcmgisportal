        ...
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="caption pull-right">
                    ...
                    <a class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl('user/chuyengia/congtac').'?id='.$model['chuyengia']->id_chuyengia?>">Công tác</a>
            ...
            <div class="portlet-body">
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function($model){
                                    return ($model->so_thang == null) ? '' : $model->so_thang;
                                },
                            ],
                            [
                                'class' => '\kartik\grid\DataColumn',
                            ...
                            [
                                ...
                                'width' => '100px',
                                'value' => function ($model) {
                                    $updateButton = "<a class='btn btn-warning btn-xs custom-element-load-ajax-div' data-toggle='modal' data-target='#ajaxModal' data-target-div='#ajaxModalContent' data-url='" . Yii::$app->urlManager->createUrl('user/dangkychuyengia/congtac/update') . '?id=' . $model->id_chuyengiacongtac . "'><i class='fa fa-pencil'></i></a>";
                                    $deleteButton = "<a class='btn btn-danger btn-xs custom-element-load-ajax-div' data-toggle='modal' data-target='#ajaxModal' data-target-div='#ajaxModalContent' data-url='" . Yii::$app->urlManager->createUrl('user/dangkychuyengia/congtac/delete') . '?id=' . $model->id_chuyengiacongtac . "'><i class='fa fa-trash'></i></a>";
                ...
                <div class="col-lg-12">
                    <a class='btn btn-success custom-element-load-ajax-div' data-toggle='modal' data-target='#ajaxModal' data-target-div='#ajaxModalContent' data-url='<?=Yii::$app->urlManager->createUrl('user/dangkychuyengia/congtac/create') . '?id=' . $model['chuyengia']->id_chuyengia ?>'><i class='fa fa-plus'></i> Thêm mới</a>
