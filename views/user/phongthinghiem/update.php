                ...
                <div class="tabbable-line form-group">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="thongtinchung">
                            <div class="col-lg-12">
                                <?= $form->field($model['phongthinghiem'], 'ten_tv')->input('text',['value' => $model['phongthinghiem']->ten_tv])->label('1.1. Tên PTN tiếng Việt') ?>
                            </div>
                            <div class="col-lg-12">
                                <?= $form->field($model['phongthinghiem'], 'ten_ta')->input('text',['value' => $model['phongthinghiem']->ten_ta])->label('1.2. Tên PTN tiếng Anh') ?>
                            </div>
                            <div class="col-lg-12">
                                <?= $form->field($model['phongthinghiem'], 'coquan_chuquan')->input('text',['value' => $model['phongthinghiem']->coquan_chuquan])->label('2. Cơ quan chủ quản') ?>
                            </div>
                            <div class="col-lg-12">
                                <?= $form->field($model['phongthinghiem'], 'dia_chi')->input('text',['value' => $model['phongthinghiem']->dia_chi])->label('3. Địa chỉ') ?>
                            </div>
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <?= $form->field($model['phongthinghiem'], 'dien_thoai')->input('text', ['value' => $model['phongthinghiem']->dien_thoai, 'onkeypress' => "return event.charCode>= 48 && event.charCode <= 57"])->label('Điện thoại') ?>
                                    </div>
                                    <div class="col-lg-6">
                                        <?= $form->field($model['phongthinghiem'], 'fax')->input('text', ['value' => $model['phongthinghiem']->fax,'onkeypress' => "return event.charCode>= 48 && event.charCode <= 57"])->label('Fax') ?>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <?= $form->field($model['phongthinghiem'], 'email')->input('email',['value' => $model['phongthinghiem']->email])->label('Email') ?>
                                    </div>
                                    <div class="col-lg-6">
                                        <?= $form->field($model['phongthinghiem'], 'website')->input('text',['value' => $model['phongthinghiem']->website])->label('Website') ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <?= $form->field($model['phongthinghiem'], 'phu_trach')->input('text',['value' => $model['phongthinghiem']->phu_trach])->label('5. Người phụ trách PTN') ?>
                            </div>
                            <div class="col-lg-6">
                                <?= $form->field($model['phongthinghiem'], 'dai_dien')->input('text',['value' => $model['phongthinghiem']->dai_dien])->label('6. Người đại diện') ?>
                            </div>
                            <div class="col-lg-12">
                        ...
                        <div class="tab-pane" id="thongtinkhac">
                            ...
                            <div class="col-lg-3">
                                <?= $form->field($model['phongthinghiem'], 'tien_si')->input('number',['value' => $model['phongthinghiem']->tien_si])->label('Tiến sĩ') ?>
                            </div>
                            <div class="col-lg-3">
                                <?= $form->field($model['phongthinghiem'], 'thac_si')->input('number',['value' => $model['phongthinghiem']->thac_si])->label('Thạc sĩ') ?>
                            </div>
                            <div class="col-lg-3">
                                <?= $form->field($model['phongthinghiem'], 'cu_nhan')->input('number',['value' => $model['phongthinghiem']->cu_nhan])->label('Kỹ sư/Cử nhân') ?>
                            </div>
                            <div class="col-lg-3">
                                <?= $form->field($model['phongthinghiem'], 'ky_thuat')->input('number',['value' => $model['phongthinghiem']->ky_thuat])->label('Kỹ thuật viên') ?>
                            </div>
                            <div class="col-lg-12">
