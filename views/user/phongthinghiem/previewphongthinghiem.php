    ...
    <div class="col-lg-12">
        <div class="portlet light">
            ...
            <div class="portlet-body">
                ...
                <div class="col-lg-12">
                    <b class=" uppercase font-blue-steel">Danh sách thiết bị </b> <a href="<?= Yii::$app->urlManager->createUrl('dang-ky-thiet-bi').'?id='.$model['pdk']['id_pdkptn']?>"><i class="fa fa-pencil"></i></a>
                ...
                <div class="col-lg-12">
                    <b class=" uppercase font-blue-steel">Sở hữu trí tuệ </b> <a href="<?= Yii::$app->urlManager->createUrl('dang-ky-so-huu-tri-tue').'?id='.$model['pdk']['id_pdkptn']?>"><i class="fa fa-pencil"></i></a>
                    <table class="table table-scrollable table-bordered table-responsive">
                ...
                <div class="col-lg-12" style="text-align: center">
                    <?php if($model['status'] == 0):?>
                        <?php $form = kartik\form\ActiveForm::begin([
                            'action' => Yii::$app->urlManager->createUrl('user/nopphieudangkyptn')
                        ])?>
                        <input type="hidden" name="id_pdk" value="<?= $model['pdk']['id_pdkptn']?>">
                        <button type="submit"
                                class="btn btn-primary"><i class="fa fa-angle-double-right"></i> Nộp phiếu đăng ký</button>
                        <?php \kartik\form\ActiveForm::end();?>
                    <?php endif;?>
                    <?php if($model['status'] == 1):?>
                        <a href="<?=Yii::$app->urlManager->createUrl('danh-sach-dang-ky')?>" class="btn btn-warning"><i class="fa fa-check"></i> Cập nhật</a>
                    <?php endif;?>
                </div>
