    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-bottom-10">
            <div class="dashboard-stat white">
                ...
                <div class="details">
                    <div class="number widget-thumb-body-stat font-green-sharp" data-counter="counterup" data-value="<?= $ptn?>"><?= $ptn?></div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="dashboard-stat white">
                ...
                <div class="details">
                    <div class="number widget-thumb-body-stat font-red-haze" data-counter="counterup" data-value="<?= $chuyengia?>"> <?= $chuyengia?> </div>
                    ...
                    <div class="portlet-body">
                        <div class="row" style="padding-bottom: 20px">
                            <div class="col-md-12">
                                ...
                                <img src="<?= Yii::$app->urlManager->createUrl('resources\img\so_khcn.jpg') ?>" class="img-responsive" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-8">
