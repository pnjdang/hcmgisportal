...
<div class="modal-header">
    ...
    <h4 class="modal-title">Thêm mới thông tin đề tài</h4>
</div>
...
<div class="modal-body">
    ...
    <div class="col-sm-12">
        <?= $form->field($model['detai'], 'noi_dung')->textarea()->label('Nội dung công việc tham gia') ?>
    </div>

    <div class="col-sm-6">
        <?= $form->field($model['detai'], 'tinh_trang')->dropDownList([1 => 'Đã nghiệm thu',0 => 'Chưa nghiệm thu'],['prompt' => 'Chọn tình trạng'])->label('Tình trạng') ?>
    </div>
    <div class="col-sm-6">
