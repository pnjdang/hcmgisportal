...
<div class="modal-header">
    ...
    <h4 class="modal-title">Cập nhật công trình nghiên cứu</h4>
</div>
<?php $form = ActiveForm::begin(); ?>
<div class="modal-body">
    <div class="col-sm-12">
        <h3>Chuyên gia: <?= $model['congtrinh']->chuyengia->ho_ten?></h3>
    </div>
    <div class="col-sm-12">
        <?= $form->field($model['congtrinh'], 'ten_congtrinh')->textarea()->label('Tên công trình') ?>
    </div>
    <div class="col-sm-12">
        <?= $form->field($model['congtrinh'], 'tac_gia')->textarea()->label('Tác giả') ?>
    </div>
    <div class="col-sm-8">
