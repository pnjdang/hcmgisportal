...
<div class="modal-body">
    <div class="col-sm-12">
        <h4>Bạn chắc chắn muốn xóa quá trình công tác từ <?= $model['congtac']->nam_batdau?> đến <?= $model['congtac']->nam_ketthuc?> tại <?= $model['congtac']->noi_congtac?></h4>
        <h4>của Chuyên gia <?= $model['congtac']->chuyengia->ho_ten?></h4>
    </div>
