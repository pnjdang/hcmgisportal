...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="<?= Yii::$app->urlManager->createUrl('admin/dangky/chuyengia') ?>">Danh sách phiếu đăng ký chuyên gia</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
    ...
    <div class="col-lg-12">
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    <span class="uppercase">Phiếu đăng ký thông tin chuyên gia</span>
                </div>
            </div>
...
//
                ...
                <div class="col-sm-12">
                    <button type="submit" class="btn btn-warning pull-left">Duyệt phiếu đăng ký chuyên gia</button>
                    <a href="<?= Yii::$app->urlManager->createUrl('admin/dangky/chuyengia') ?>"
                       class="btn btn-default pull-right">Danh sách phiếu đăng ký chuyên gia</a>
                </div>
