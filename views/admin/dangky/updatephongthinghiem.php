                ...
                <div class="tabbable-line form-group">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="thongtinkhac">
                            ...
                            <div class="col-lg-12">
                                <button type="submit" class="btn btn-warning pull-left"> Duyệt phiếu đăng ký phòng thí nghiệm</button>
                                <button type="button" class="btnPrevious btn btn-default pull-left"><i class="fa fa-angle-double-left"></i> Quay lại</button>
                                <a class="btn btn-default pull-right" href="<?=Yii::$app->urlManager->createUrl('admin/dangky/phongthinghiem')?>"> Danh sách phiếu đăng ký phòng thí nghiệm</a>
                            </div>
                            <div style="clear: both"></div>
                        </div>
                    </div>
