            ...
            <div class="portlet-body">
                <table class="table table-bordered table-striped">
                    <tr>
                        ...
                        <th>Số lượng phòng thí nghiệm</th>
                    </tr>
                    <?php if($model['linhvucthunghiem'] != null):?>
                        <?php foreach($model['linhvucthunghiem'] as $i => $linhvucthunghiem):?>
                            <tr>
                                <td><?= $i +1?></td>
                                <td><a href="<?= Yii::$app->urlManager->createUrl('admin/danhsachphongthinghiem/linhvucchitiet').'?id='.$linhvucthunghiem->id_lv?>"><?= $linhvucthunghiem->ten_lv?></a></td>
                                <td><?= $model['soluong'][$i]?></td>
                            </tr>
                        <?php endforeach?>
                    <?php endif?>
                </table>
