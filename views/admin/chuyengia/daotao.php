        ...
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="caption pull-right">
                    ...
                    <a class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl('admin/chuyengia/daotao').'?id='.$model['chuyengia']->id_chuyengia?>">Đào tạo</a>
            ...
            <div class="portlet-body">
                ...
                <div class="col-lg-12">
                    <a class="btn btn-warning pull-left"
                       href="<?= Yii::$app->urlManager->createUrl('admin/capnhatchuyengia/daotao/daotao') . '?id=' . $model['chuyengia']->id_chuyengia ?>">Cập
                        nhật thông tin</a>
