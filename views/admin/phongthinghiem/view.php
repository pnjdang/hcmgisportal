        ...
        <div class="portlet light">
            <div class="portlet-title">
                ...
                <div class="caption pull-right">
                    ...
                    <a class="btn btn-default"
                       href="<?= Yii::$app->urlManager->createUrl('admin/phongthinghiem/thietbithunghiem') . '?id=' . $model['phongthinghiem']->id_ptn ?>">Thiết bị thử nghiệm</a>
                    <a class="btn btn-default"
                       href="<?= Yii::$app->urlManager->createUrl('admin/phongthinghiem/sohuutritue') . '?id=' . $model['phongthinghiem']->id_ptn ?>">Sở hữu trí tuệ</a>
            ...
            <div class="col-lg-12">
                <a class="btn btn-warning pull-left"
                   href="<?= Yii::$app->urlManager->createUrl('admin/phongthinghiem/update') . '?id=' . $model['phongthinghiem']->id_ptn ?>">Cập
                    nhật thông tin</a>
