            ...
            <div class="display">
                <div class="number">
                    <h3 class="font-red-haze">
                        <span data-counter="counterup" data-value="1349"><?= $model['chuyengia']['so_luong'] ?></span>
                    </h3>
...
<div class="row">
    <div class="col-md-6 col-sm-6">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                <div id="chart1" class="" style="height: 300px;width: 100%"></div>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-sm-6">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">Chuyên gia theo nhóm đơn vị</span>
                </div>
                <div class="actions">
                    <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="#"> </a>
                </div>
            ...
            <div class="portlet-body">
                <div id="chart2" class="" style="height: 300px;width: 100%"></div>
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject bold uppercase font-dark">Phòng thí nghiệm theo lĩnh vực</span>
                </div>
                <div class="actions">
                    <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="#"> </a>
                </div>
            ...
            <div class="portlet-body">
                <div id="chart3" class="" style="height: 500px;width: 100%"></div>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    var chart2 = AmCharts.makeChart("chart2", {
        ...
        "labelsEnabled": false,
        "dataProvider": <?= json_encode($model['chuyengia']['nhomdonvi'], JSON_UNESCAPED_UNICODE)?>,
        "valueField": "so_luong",
        "titleField": "ten_nhom",
        "balloon": {
            "fixedPosition": true
        },
        "balloonText": "[[title]]<br><span style='font-size:12px'><b>[[value]]</b> chuyên gia ([[percents]]%)</span>",
        "depth3D": 15,
        "angle": 30,
        "outlineAlpha": 0.4,
        "export": {
    ...
    var chart3 = AmCharts.makeChart("chart3", {
        ...
        "theme": "light",
        "marginRight": 70,
        "dataProvider": <?= json_encode($model['phongthinghiem']['linhvuc'], JSON_UNESCAPED_UNICODE)?>,
        "valueAxes": [{
            "axisAlpha": 0,
            "position": "left",
            "title": ""
        ...
        "startDuration": 1,
        "graphs": [{
            "balloonText": "<b>Số lượng phòng thí nghiệm hoạt động trong lĩnh vực [[category]]: [[value]]</b>",
            "fillColorsField": "color",
            "fillAlphas": 0.9,
            "lineAlpha": 51.2,
            "type": "column",
