...
<div class="modal-header">
    ...
    <h4 class="modal-title">Xóa thông tin đề tài</h4>
</div>
<?php $form = ActiveForm::begin(); ?>
<div class="modal-body">
    <div class="col-sm-12">
        <h4>Bạn chắc chắn muốn xóa thông tin đề tài <?= $model['detai']->ten_detai?></h4>
        <h4>của Chuyên gia <?= $model['detai']->chuyengia->ho_ten?></h4>
    </div>
