            ...
            <div class="portlet-body">
                    ...
                    GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'width' => '100px',
                                'value' => function ($model) {
                                    $updateButton = "<a class='btn btn-warning btn-xs custom-element-load-ajax-div' data-toggle='modal' data-target='#ajaxModal' data-target-div='#ajaxModalContent' data-url='" . Yii::$app->urlManager->createUrl('admin/capnhatchuyengia/detai/update') . '?id=' . $model->id_chuyengiadetai . "'><i class='fa fa-pencil'></i></a>";
                                    $deleteButton = "<a class='btn btn-danger btn-xs custom-element-load-ajax-div' data-toggle='modal' data-target='#ajaxModal' data-target-div='#ajaxModalContent' data-url='" . Yii::$app->urlManager->createUrl('admin/capnhatchuyengia/detai/delete') . '?id=' . $model->id_chuyengiadetai . "'><i class='fa fa-trash'></i></a>";
                        ...
                        'panel' => [
                            ...
                            'after' => "<a class='btn btn-success btn-xs custom-element-load-ajax-div' data-toggle='modal' data-target='#ajaxModal' data-target-div='#ajaxModalContent' data-url='" . Yii::$app->urlManager->createUrl('admin/capnhatchuyengia/detai/create') . '?id=' . $model['chuyengia']->id_chuyengia . "'><i class='fa fa-plus'></i> Thêm mới</a>",
                            'footer' => false
                        ]
                    ])
                    ?>
                ...
                <div class="col-lg-12">
                    <a class="btn btn-default pull-left"
                       href="<?= Yii::$app->urlManager->createUrl('admin/chuyengia/detai') . '?id=' . $model['chuyengia']->id_chuyengia ?>">Quay lại</a>
