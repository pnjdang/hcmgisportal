...
/* @var $searchModel app\models\GisPostsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : Yii::t('app', 'Gis Posts');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['title'=> 'Thêm mới bài viết','data-pjax'=>0,'class'=>'btn btn-success']).
            ...
            'panel' => [
                ...
                'heading' => '<i class="glyphicon glyphicon-list"></i> Danh sách bài viết',
                'before'=>'',
