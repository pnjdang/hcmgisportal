    ...
    <div class="row">
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="https://portal.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/portalhcmgis_thumb-copy.png" alt="#"></a></div>
          <div class="team_imform">
              <p class="team_mem_name"><a href="https://portal.hcmgis.vn/" target="_blank">HCMGIS PORTAL</a></p>
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="https://maps.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/maphcmgis_thumb.png" alt="#"></a></div>
          <div class="team_imform">
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="https://geosurvey.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/banner_tourmap-2.jpg" alt="#"></a></div>
          <div class="team_imform">
              <p class="team_mem_name"><a href="https://geosurvey.hcmgis.vn/" target="_blank">HCMGIS GEOSURVEY</a></p>
      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="http://georeference.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/georefercence-300x159.png" alt="#"></a></div>
          <div class="team_imform">
              <p class="team_mem_name"><a href="http://georeference.hcmgis.vn/" target="_blank">HCMGIS GEOREFERENCE</a></p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="https://opendata.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/banner_HCMGIS_Opendata.jpg" alt="#"></a></div>
          <div class="team_imform">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="https://storymaps.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/storymap.png" alt="#"></a></div>
          <div class="team_imform">
              <p class="team_mem_name"><a href="https://storymaps.hcmgis.vn/" target="_blank">HCMGIS STORYMAPS</a></p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="https://geotag.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/geotag_thumb.jpg" alt="#"></a></div>
          <div class="team_imform">
              <p class="team_mem_name"><a href="https://geotag.hcmgis.vn/" target="_blank">HCMGIS GEOTAG</a></p>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="https://geoevents.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/geoevents.jpg" alt="#"></a></div>
          <div class="team_imform">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
        <div class="full team_blog">
            <div class="team_member_img"><a href="http://geostats.hcmgis.vn/" target="_blank"><img src="<?= Yii::$app->homeUrl?>images/geostats_thumb.jpg" alt="#"></a>
          </div>
          <div class="team_imform">
...
<section>
    <div class="container">
        ...
        <div class="row margin_bottom_30">
               <!-- featured image -->
               <div class="col-md-12 wow fadeInRight" data-wow-delay="0.5" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInRight;">
                  <div class="full">
