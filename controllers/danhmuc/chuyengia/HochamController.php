...
use app\models\danhmuc\chuyengia\hocham\SearchHocham;
use Yii;
 ...
 */
class HochamController extends AbstractAdminController
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * Lists all HocHam models.
     * @return mixed
     */
    public function actionIndex()
    {    
        $searchModel = new SearchHocham();
    ...
    /**
     * Displays a single HocHam model.
     * @param integer $id
     * @return mixed
     */
        ...
        if($request->isAjax){
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_hh]);
            } else {
    ...
    /**
     * Updates an existing HocHam model.
     * For ajax request will return json object
    ...
    /**
     * Delete an existing HocHam model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing HocHam model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    /**
     * Finds the HocHam model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return HocHam the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = HocHam::findOne($id)) !== null) {
            return $model;
        } else {
